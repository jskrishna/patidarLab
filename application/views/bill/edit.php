...
<div class="layoutSidenav_content">
    <div class="layout_content_inr">
            ...
            <h2>Bill Edit</h2>
            <button class="btn custom-btn patientedit_btn" data-id="<?php echo $patientData->id ?>" data-bs-toggle="modal" data-id="<?php echo $patientData->id; ?>" data-bs-target="#patientEdit">Edit Patient</button>
        </div>
        <div class="tests-sec">
            <div class="form-row">
                <div class="col-lg-12">
